// ai-town pixel spritesheet geometry (public/assets/town/folk.png, 384×256).
// Sheet holds 8 characters in a 4×2 grid; each character is a 96×128 block of
// 32px tiles: rows = down/left/right/up, columns = 3 walk-cycle frames.
// (Frame layout taken from a16z-infra/ai-town data/spritesheets/f1.ts.)
...
export const SHEET_H = 256 * SCALE;
